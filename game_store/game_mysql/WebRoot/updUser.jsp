...
<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
 ...
 <script src="https://cdn.bootcss.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"></script> 
  ...
  <body style="color:black;background:#FFF url(images/back.jpg) no-repeat;height:100%;width:100%;background-size:cover;" >	
   <form id="signUpForm" action="<%=request.getContextPath() %>/user/updUser.do"  >
	        ...
	        <td width="70%">
				 <div class="input-group mb-3">
				  <div class="input-group-prepend">
				   ...
				   <input name="oldLoginName"  value="${user.loginName }" type="hidden">
				  <input name="id"  value="${user.id }" type="hidden">
				  <input type="text" value="${user.loginName }" name="loginName" id="loginName"  class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
				  </div> 
        ...
        <tr  height="50">
	        ...
	        <td>
				 <div class="input-group mb-3">
				  ...
				  <input type="password" name="passWord" value="${user.passWord }" id="passWord"  class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
				</div> 
	        </td>
        </tr>
        <tr>
        ...
        <tr  height="50">
	        ...
	        <td>
				 <div class="input-group mb-3">
				  ...
				  <input type="password" name="surePassWord"  value="${user.passWord }"  id="surePassWord"  class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
				</div> 
	        </td>
        </tr>        
        <tr>
         ...
         <tr  height="50">
	        ...
	        <td>
				 <div class="input-group mb-3">
				  ...
				  <input   name="phoneNum" id="phoneNum"   value="${user.phoneNum }" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
				</div> 
	        </td>
        </tr>  
        <tr>
         ...
         <tr  height="50">
	        ...
	        <td>
				 <div class="input-group mb-3">
				  ...
				  <input   name="qqNum" id="qqNum"    value="${user.qqNum }"  class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default">
				</div> 
	        </td>
        </tr>  
        <tr>
