...
<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
 ...
 <script src="https://cdn.bootcss.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"></script> 
  ...
  <body style="color:black;font-weight:bold;background:#FFF url(images/back.jpg) no-repeat;height:100%;width:100%;background-size:cover;" >	
   <form id="signUpForm" action="<%=request.getContextPath() %>/user/signUp.do"  >
...
<!--         <Tr height="24%"><th><captioN style="font-size: 30;text-align:center"><b>注册</b></captioN><th></Tr> -->
        ...
        <tr  height="50"  style="text-align:center">
          ...
          <Td>
            <button  id="submitBtn"  type="button"  class="btn btn-outline-primary"  >注册
			    </button>  
