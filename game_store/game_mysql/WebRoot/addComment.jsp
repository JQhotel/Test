...
<script src="https://cdn.bootcss.com/jquery/3.2.1/jquery.min.js"></script>
 ...
 <script src="https://cdn.bootcss.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"></script> 
  ...
  <body style="color:black;background:#FFF url(images/back.jpg) no-repeat;height:100%;width:100%;background-size:cover;" >	
   <form id="demoForm"  method="post" action="<%=request.getContextPath() %>/order/addComment.do"  >
   ...
   <h1>发表评论</h1>
        ...
        <tr  height="50">
            <td>   </td>
	        <td> 
	              <textarea  class="form-control" name="comment" id="comment"  aria-label="评论">不错哟！</textarea>
        ...
        <tr  height="50"  style="text-align:center">
          ...
          <Td>
           <button  id="submitBtn1"  type="button" class="btn btn-dark"  >评论
			    </button>  
